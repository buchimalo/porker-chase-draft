    ...
    function createMockDb() {
        ...
        let root = load() || {
            draft: {
                currentRound: 1,
                teams: {
                    team1: { id: 'team1', name: 'チームA' },
                    team2: { id: 'team2', name: 'チームB' },
                    team3: { id: 'team3', name: 'チームC' },
                    team4: { id: 'team4', name: 'チームD' },
                    team5: { id: 'team5', name: 'チームE' }
                },
                nominations: {},
                players: ['プレイヤー01', 'プレイヤー02', 'プレイヤー03', 'プレイヤー04', 'プレイヤー05',
                    'プレイヤー06', 'プレイヤー07', 'プレイヤー08', 'プレイヤー09', 'プレイヤー10',
                    'プレイヤー11', 'プレイヤー12', 'プレイヤー13', 'プレイヤー14', 'プレイヤー15',
                    'プレイヤー16', 'プレイヤー17', 'プレイヤー18', 'プレイヤー19', 'プレイヤー20',
                    'プレイヤー21', 'プレイヤー22', 'プレイヤー23', 'プレイヤー24', 'プレイヤー25'].join('\n'),
